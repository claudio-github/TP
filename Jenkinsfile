                        ...
                        steps {
                            script {
                                    withCredentials([
                                        ...
                                        sh 'az webapp config container set --name webtalentpool --resource-group TALENT-POOL-RG --docker-custom-image-name containerregistrytalentpool.azurecr.io/web01_image'
                                    }
                                }
                            }
                        }
